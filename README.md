...
This project is based on SensESP 2.x which is not maintained anymore. This repo is therefor archived.\
A new repo [bhavers/sh-esp32-engine-hat](https://github.com/bhavers/sh-esp32-engine-hat), based on SensESP 3.x, was created that contains the latest changes.
